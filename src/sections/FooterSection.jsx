...
const PortfolioFooter = () => {
  ...
  return (
    <footer ref={footerRef} className="relative bg-[#0d1224]  text-white overflow-hidden">
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div 
              ...
              onClick={scrollToTop}
            >
              <div className="w-16 h-16 rounded-full bg-gradient-to-r from-pink-500 via-purple-500 to-blue-600 flex items-center justify-center text-2xl font-bold transform hover:scale-110 transition-transform duration-300">
                YL
              </div>
              <div>
                <h3 className="text-2xl font-bold bg-gradient-to-r from-pink-500 via-purple-500 to-blue-600 bg-clip-text text-transparent">
                  Giannis Giotis
                </h3>
...
<div class="flex items-center gap-4">
      ...
      >
        ...
        >
          <path
            ...
            class="group-hover:fill-white fill-white duration-300"
          ></path>
          <path
  ...
  <div class="social-button">
    <button class="relative w-12 h-12 rounded-full group">
      <div
        class="floater w-full h-full absolute top-0 left-0 bg-red-600 rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"
      ></div>
      <div
        class="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-red-600 rounded-full"
      >
        <svg
          fill="none"
          viewBox="0 0 30 22"
        ...
        >
          ...
          ></path>
            ...
            <div className="mt-8 space-y-3">
              <h5 className="text-sm font-semibold text-gray-300">Stay Updated</h5>
              <div className="flex">
                <input
                  type="email"
        ...
        <div ref={bottomRef} className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <div className="text-gray-400 text-sm">
            © 2025 Your Name. All rights reserved. Made with ❤️ and lots of ☕
          </div>
